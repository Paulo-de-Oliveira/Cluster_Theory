...
output_folder = "8_measurements_generation/4_measurements"
...
# Q_sensors = c(Q_sensors, "215")
# monitoring_case = "2flow"
# Q_sensors = c(Q_sensors, "215", "247")
# monitoring_case = "3flow"
# Q_sensors = c(Q_sensors, "215", "247", "191")
# monitoring_case = "4flow"
# Q_sensors = c(Q_sensors, "215", "247", "191", "271")
monitoring_case = "5flow"
Q_sensors = c(Q_sensors, "215", "247", "191", "271", "161")
